...
class FoursquareDataAccess extends myOauthBase
{
  protected
    $oauth;
  ...
  public function init($user_token_array, $oauth_encryption=OAUTH_SIG_METHOD_HMACSHA1, $oauth_type=OAUTH_AUTH_TYPE_URI)
  {
    ...
    {
      sfContext::getInstance()->getLogger()->info('{FoursquareDataAccess} init: req:'.$user_token.' secret:'.$user_token_secret);
    }
  }
  
  public function getUserInfo()
  {
    $this->oauth->fetch('http://api.foursquare.com/v1/user.json'); 
